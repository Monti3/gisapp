...
import 'package:myapp/temps/dropdownbutton_temp.dart';
...
List topicPrompt = <List>[
  ...
  [
    'Trig identities and equations. give a starting expression and a final expression',
    'Ident. trigonométricas'
  ],
              ...
              children: [
                DropdownMenu<String>(
                  ...
                  onSelected: (value) {
                    setState(() {
                      topic =
                          topicPrompt[topicList.indexOf(value.toString())][0];
                      print(topic);
                    });
                  },
                  dropdownMenuEntries:
                ...
                IconButton(
                  ...
                  onPressed: () {
                    ...
                    print('sc> $studentsQuantity, $excersicesPerAlumn');
                    prompt();
                  },
                ),
              ],
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: NumberDropdown(
                          ...
                          onChanged: (value) {
                            setState(() {
                              studentsQuantity = value;
                              print(excersicesPerAlumn);
                            });
                          },
                          title: '',
                        ),
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: NumberDropdown(
                          ...
                          onChanged: (value) {
                            setState(() {
                              print('slide val: $value');
                              excersicesPerAlumn = value;
                            });
                            print('value: $value');
                          },
                          title: 'Alumnos',
